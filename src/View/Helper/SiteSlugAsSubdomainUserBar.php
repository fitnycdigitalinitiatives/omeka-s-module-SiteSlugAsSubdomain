 ...
 */
class SiteSlugAsSubdomainUserBar extends AbstractHelper
{
    /**
     * The default partial view script.
     */
    const PARTIAL_NAME = 'common/site-slug-as-domain-user-bar';
    ...
    public function __invoke($partialName = null)
    {
        ...
        $links = $user ? $this->links($view, $site, $user, $adminname) : [];
     ...
     * @return array
     */
    protected function links(RendererInterface $view, SiteRepresentation $site, User $user, $adminname)
    {
        ...
        $links[] = [
            ...
            'action' => 'show',
            'text' => $site->title(),
            'url' => $adminname . $site->adminUrl('show'),
        ];
        ...
        if ($controller === 'page') {
            if ($routeParams['action'] === 'show') {
                $links[] = [
                    ...
                    'url' => $adminname . $url('admin/site/slug/action', ['site-slug' => $site->slug(), 'action' => 'page']),
                ];
                try {
                    ...
                    if ($page->userIsAllowed('edit')) {
                        $links[] = [
                            ...
                            'action' => 'edit',
                            'text' => $translate('Edit'),
                            'url' => $adminname . $page->adminUrl('edit'),
                        ];
                    }
            ...
            $links[] = [
                ...
                'action' => 'browse',
                'text' => $translate($mapPluralLabels[$controller]),
                'url' => $adminname . $url('admin/default', ['controller' => $controller], ['query' => ['site_id' => $site->id()]]),
            ];
            ...
            if ($id) {
                ...
                $links[] = [
                    ...
                    'action' => 'show',
                    'text' => $translate('View'),
                    'url' => $adminname . $resource->adminUrl(),
                ];
                if ($resource->userIsAllowed('edit')) {
                    $links[] = [
                        ...
                        'action' => 'edit',
                        'text' => $translate('Edit'),
                        'url' => $adminname . $resource->adminUrl('edit'),
                    ];
                }
            }
        }
